 ...
 */
module.exports = function getAuthorizationGrant(config) {
  ...
  function authorizeURL(params) {
    ...
    const authorizeUrl = isAbsolute ? config.authorizationPath : `${config.site}${config.authorizationPath}`;

    return `${authorizeUrl}?${qs.stringify(params)}`;
  }
